...
with T["🎯 勝てる商品"]:
    ...
    with left:
        ...
        if lw.empty:
            ...
            st.caption(
                "🚨 **2026-09-24に逆側も測れた。** ヤフオク→ヤフオクの前向き台帳22件が"
                "決着して、**競りが付いた玉は終値が中央値の0.81〜0.99倍まで上がる**"
                "(うちの上限は0.66〜0.75倍)。6敗のうち上限の1.1倍以内に入ったんは1件だけや。"
                "つまり**早う見つけた質のええ玉は、質がええから他人も入札する**。"
                "**🔥競り中** の旗はそれ。逆に **🤫入札なし** は取れるが、"
                "入札ゼロで終わった14件のうち機械検品を通ったんは**0件**やった——"
                "誰も競らんのは本文に欠陥が書いてあるからや。"
                "**取れる玉と欲しい玉がほぼ重ならん、いうんがこの筋の形。** "
                "旗は門やない(n=8)。前向き台帳に入札数が溜まるまでは切らん。")
