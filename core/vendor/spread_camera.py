...
import is_body as IB  # noqa: E402  日本語の部品語の正本
import statistics
...
# **日本語の部品語は is_body に集約した(2026-08-24)。**
# 4ファイルに散っとると移し忘れでズレる。パターンは変わっとらん。
PARTS_RE = IB.JP_PARTS_CAMERA
JUNK_RE = re.compile(
    # **英字の JUNK が入っとらんかった。**「★[JUNK]」表記の出品が全部素通りして、
    ...
    r"現状|1円[〜～~]|1円スタート|要確認|"
    # 2026-08-11: 「不良有り」が語彙に無かった。難あり|難アリ|難有り|訳あり では拾えん
    r"不良有|不良あり|不具合有|不具合あり")
